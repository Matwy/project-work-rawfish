...
const qaCreateSchemas = require("./qacreate_schemas.json")

// For CJS, it generates an exports array, will generate
// `exports["#/definitions/Foo"] = ...;exports["#/definitions/Bar"] = ... ;`
const ajv = new Ajv({ schemas: [usersSchemas, fightpointsSchemas, qaSchemas, qaCreateSchemas], code: { source: true } })
